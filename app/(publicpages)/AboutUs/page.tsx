    ...
    return (
        <div className='mx-36'>
            ...
            <div className="my-4 grid grid-cols-3">
                <div className="card">
                    <img src='https://lostfoundway.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fab1.7ef6ef2c.jpg&w=256&q=75'/>
                    <h2 className='mt-4'>Daniel Marko</h2>
                    <p>CEO</p>
                </div>
                <div className="card">
                    <img src='https://lostfoundway.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fab2.ab706599.png&w=256&q=75'/>
                    <h2 className='mt-4'>Arshi Doby</h2>
                    <p>CTO</p>
                </div>
                <div className="card">
                    <img src='https://lostfoundway.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fab3.8067cb54.jpeg&w=128&q=75'/>
